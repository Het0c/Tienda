from PyQt5.QtWidgets import QWidget, QVBoxLayout, QLabel, QMessageBox,QTableWidget, QTableWidgetItem, QPushButton, QHBoxLayout
...
def crear_pagina_arqueo():
    ...
    def confirmar_cierre():
        ...
        msg.setText("¿Desea proceder con el arqueo y cerrar la caja?\nLos cambios serán guardados.")
